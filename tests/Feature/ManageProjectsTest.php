...
class ManageProjectsTest extends TestCase
{
     ...
     * @test
     */
    public function tasks_can_be_included_as_part_as_a_new_project_creation()
    {
        $this->signIn();
     ...
     * @test
     */
    public function a_user_can_all_projects_they_have_been_invited_to_on_their_dashboard()
    {
        $user = $this->signIn();
